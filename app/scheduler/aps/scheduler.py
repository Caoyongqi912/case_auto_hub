...
from .jobs import aps_heartbeat, print_jobs, aps_submit_interface_task, aps_submit_play_task
...
class HubScheduler:
    ...
    async def initialize(self, redis: "RedisClient") -> bool:
        ...
        if acquired:
            ...
            log.info("[Scheduler] : Initialized as master (started in paused mode)")
            # 心跳
